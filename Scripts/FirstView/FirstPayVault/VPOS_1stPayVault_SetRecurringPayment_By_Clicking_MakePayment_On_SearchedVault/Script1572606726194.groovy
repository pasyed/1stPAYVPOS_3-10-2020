...
CustomKeywords.'utilities.SafeActions.safeSelectOptionInDropDownByVisibleText'(findTestObject('Pages/Sale/dropDown_Frequency_TransactionComplete'), 
    'Weekly', 'Select By Value', (([GlobalVariable.PageLoadTime]) as int[]))
...
CustomKeywords.'utilities.SafeActions.safeType'(findTestObject('Pages/FirstPayVault/textBox_EmailAddress_TransactionComplete'), 
    GlobalVariable.emailAddress, 'Enter EmailAddress into text box', (([GlobalVariable.PageLoadTime]) as int[]))
...
CustomKeywords.'utilities.SafeActions.verifyPopupMessage'('Your Setup has been completed.', popUpMessage)
...
CustomKeywords.'utilities.SafeActions.safeClickWithoutScroll'(findTestObject('Pages/FirstPayVault/closeLocatorForDeletePopupMessage'), 
    'Click on Save and Return', (([GlobalVariable.PageLoadTime]) as int[]))
