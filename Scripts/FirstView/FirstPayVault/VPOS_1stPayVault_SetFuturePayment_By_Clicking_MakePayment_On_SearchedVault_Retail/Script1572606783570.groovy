...
CustomKeywords.'utilities.SafeActions.safeClickWithoutScroll'(findTestObject('Pages/FirstPayVault/date_FuturePayment'), 
    'Click on FuturePayment Date', (([GlobalVariable.delayForElement]) as int[]))
...
CustomKeywords.'utilities.SafeActions.safeClickwithScroll'(findTestObject('Pages/FirstPayVault/button_ReturnToVault_InTransactionComplete'), 
    'Click on Return To Vault', (([GlobalVariable.PageLoadTime]) as int[]))
